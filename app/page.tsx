    ...
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-14 flex items-center">
        <Link className="flex items-center justify-center" href="/">
          ...
          <span className="sr-only">Future Focus Academy</span>
        </Link>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              <Card>
                ...
                <CardContent>
                  <CardDescription>Access a wide range of courses across various disciplines.</CardDescription>
                </CardContent>
              </Card>
              <Card>
                <CardHeader>
              ...
              <Card>
                ...
                <CardContent>
                  <CardDescription>Earn recognized certifications upon course completion.</CardDescription>
                </CardContent>
              </Card>
              <Card>
                <CardHeader>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">© 2025 Future Focus  Academy. All rights reserved.</p>
